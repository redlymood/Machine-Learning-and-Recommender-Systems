...
// NOTE: u.item has 19 genre columns; the FIRST one is "unknown".
// We include it here so the 19 names line up 1:1 with the 19 numeric flags.
const genreNames = [
...
function parseItemData(text) {
    ...
    for (const line of lines) {
        ...
        // Extract the 19 raw genre flags (columns 5..23) as integers 0/1.
        // This numeric vector is what cosine similarity will use.
        const genreVector = fields.slice(5, 24).map(value => parseInt(value, 10));

        // Human-readable genre names, aligned 1:1 with the 19-length vector.
